...
class _AddLoanScreenState extends State<AddLoanScreen> {
  ...
  final List<String> _loanCategories = [
    'Personal Loan',
    'Home Loan',
    'Car Loan',
    'Student Loan',
  ...
  void _saveLoan() {
    if (_formKey.currentState!.validate()) {
      // TODO: Implement save loan logic
              ...
              child: Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    items: _loanCategories.map<DropdownMenuItem<String>>((String value) {
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Please enter a loan title';
                    }
                    return null;
                  },
                ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  decoration: const InputDecoration(
                    hintText: 'Enter loan description',
                    hintStyle: TextStyle(
                      color: Color(0xFF00D09E),
                      fontSize: 15,
                      fontFamily: 'Poppins',
